...
class Park extends CityHold {
  ...
  //calculate density of park up to number of trees
  calucDensity() {
    const densityOfTrees = this.numOfTrees / this.sizeOfPark
    console.log(`${this.name} has a tree density of ${densityOfTrees} square km.`);
  }
}
...
class Street extends CityHold {
  constructor(name, yearOfMade, streetLength, size = 3) {
    ...
    classifyStreet() {
      ...
      console.log(`${this.name}, build in ${this.yearOfMade}, is a ${classification.get(this.size)}`)
    }
}
